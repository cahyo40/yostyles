...
class YoColor {
  ...
  static const MaterialColor zinc =
      MaterialColor(_zincPrimaryValue, <int, Color>{
    50: Color(0xFFFAFAFA),
  ...
  static const MaterialColor stone =
      MaterialColor(_stonePrimaryValue, <int, Color>{
    50: Color(0xFFFAFAF9),
  ...
  static const MaterialColor emerald =
      MaterialColor(_emeraldPrimaryValue, <int, Color>{
    50: Color(0xFFECFDF5),
  ...
  static const MaterialColor sky = MaterialColor(_skyPrimaryValue, <int, Color>{
    50: Color(0xFFF0F9FF),
  ...
  static const MaterialColor violet =
      MaterialColor(_violetPrimaryValue, <int, Color>{
    50: Color(0xFFF5F3FF),
  ...
  static const MaterialColor fuchsia =
      MaterialColor(_fuchsiaPrimaryValue, <int, Color>{
    50: Color(0xFFFDF4FF),
  ...
  static const MaterialColor rose =
      MaterialColor(_rosePrimaryValue, <int, Color>{
    50: Color(0xFFFFF1F2),
